...
- ## 테이블 형식이 아닌 데이터 구조
  ...
  - ***분야에 따른 그래프 의미***
    - **컴퓨터 분야:**
      - 그래프라는 용어는 일반적으로 어떤 개체들 사이의 연결 관계를 묘사하기 위한 도구이자 데이터 구조로 사용
    - **통계 분야:**
...
- ## 위치 추정
  ...
  - ***추정? 측정?***
    ...
    - **통계학자**:
      ...
      데이터로부터 얻은 값과 실제 상태를 나타내는 이론적인 참값의 구분을 위해 데이터로부터 계산된 값들을 추정값이라고 명명
...
- ## 상관관계
  ...
  - ***주요 개념***
    ...
    - 상관계수가 0이라는 것은 아무런 상관성이 없다는 것을 의미. 
    - **데이터를 랜덤하게 재배치 시, 우연히 상관계수가 양/음수가 될 수 있음**
